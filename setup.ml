...
(* OASIS_START *)
(* DO NOT EDIT (digest: ff75cf2dee208a7e0847514874e1a451) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "A context-free grammar based random string generator";
          description = None;
          categories = [];
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "grammar"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "grammar"; InternalLibrary "lexer"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "cfgen.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\025:xC\147Q\216\250s\025\001H.7\227R";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
