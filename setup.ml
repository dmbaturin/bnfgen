...
(* OASIS_START *)
(* DO NOT EDIT (digest: e432c9209fc805b4e7d7cb27cd938272) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "A context-free grammar based random text generator";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "qQ\146~\r\134\254&wL\144\141\233\1760\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
